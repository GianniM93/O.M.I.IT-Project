...
const SingleVPost = ({id,category,title,cover,value,unit,name,avatar,content,date,postComments,myInfo}) => {
...
return (
 ...
 {isModalOpen && (<AddComment infoId={id} infoName={name} userInfo={myInfo} close={setIsModalOpen} /> )}
  </Modal.Header>
  <Modal.Body>
  <CommentList infoId={id} comments={postComments} userInfo={myInfo} />
  </Modal.Body>
  <Modal.Footer>
